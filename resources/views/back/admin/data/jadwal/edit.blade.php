                            ...
                            <div class="col-lg-12">
                                <div class="card m-b-20">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('storeJadwal') }}" method="POST" class='mt-3' >
                                            @csrf
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="mapel" id="mapels" class="form-control @error('mapel') is-invalid @enderror">
                                                        ...
                                                        <option value="{{ $mapel->id }}" {{$mapel->id == $jadwal->mapel_id ? 'selected' : ''}}>{{ $mapel->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('mapel')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="time" name="start_time" class='form-control  @error('start_time') is-invalid @enderror' value="{{$jadwal->start_time}}">
                                                    @error('start_time')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="time" name="end_time" class='form-control  @error('end_time') is-invalid @enderror' value="{{$jadwal->end_time}}">
                                                    @error('end_time')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
