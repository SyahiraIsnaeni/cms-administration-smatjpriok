                                ...
                                <div class="card-body">
                                    <div class="card-header" style="display: flex;margin-left: -20px">
                                        <div class="card-head-row">
                                            <a href="{{route("siswa")}}" class="btn btn-warning ml-auto"> <i class="bi bi-arrow-left-circle"></i> Kembali </a>
                                        </div>
                                        <div class="card-head-row" style="margin-left: 10px">
                                            <a href="{{ route('add-siswa', ['kelasId' => $kelas->id]) }}" class="btn btn-info btn=sm ml-auto"> <i class="bi bi-plus-circle" style="margin-right: 4px"></i>Tambah Data</a>
                                        </div>
                                        <div class="card-head-row" style="margin-left: 10px">
                                            <a href="{{ route('add-siswa-import', ['kelasId' => $kelas->id]) }}" class="btn btn-success btn=sm ml-auto">
                                        ...
                                        <div class="card-head-row" style="margin-left: 10px">
                                            <form action="{{route('reset-siswa', ['kelasId' => $kelas->id])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                    ...
                                                    <table class="table table-bordered mb-3" id="table1">
                                                        ...
                                                        @forelse($siswas as $row)
                                                            <tr>
                                                                ...
                                                                <td class="text-bold-500">{{ $row->jenis_kelamin }}</td>
                                                                <td class="text-bold-500">
                                                                    <a href="{{ route('edit-siswa', ['id' => $row->id, 'kelasId' => $kelas->id]) }}" class="btn icon btn-primary">
                                                                        <i class="bi bi-pencil"></i>
                                                                    </a>
                                                                    <br>
                                                                    <form method="post" action="{{ route('delete-siswa', ['id' => $row->id, 'kelasId' => $kelas->id]) }}" class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
