                                                        ...
                                                        @forelse($pengumumans as $pengumuman)
                                                            <tr>
                                                                ...
                                                                <td class="text-bold-500">
                                                                    <form method="post" action="{{ route('restore-riwayat-pengumuman', $pengumuman->id) }}" class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                    ...
                                                                    <br>
                                                                    <form method="post" action="{{ route('delete-riwayat-pengumuman', $pengumuman->id) }}" class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
