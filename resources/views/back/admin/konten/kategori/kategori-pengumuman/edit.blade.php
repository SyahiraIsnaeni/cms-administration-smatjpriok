                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="{{route("kategori-pengumuman")}}" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="{{ route('edit-kategori-pengumuman', $kategori_pengumumans->id)}}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PATCH')
                                            <div class="form-group">
                                                <label for="squareText">Nama Kategori</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Nama Kategori" name="kategori" value="{{$kategori_pengumumans->kategori}}">
                                            </div>
                                            <div class="form-group">
