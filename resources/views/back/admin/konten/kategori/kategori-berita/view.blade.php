                                            ...
                                            <div class="card-body" >
                                                <div class="table-responsive" style="margin-left: -20px;margin-top: -20px;">
                                                    <table class="table table-bordered mb-3" id="table1">
                                                        ...
                                                        <tbody>
                                                        @forelse($kategori_beritas as $kategori)
                                                            <tr>
                                                                <td class="text-bold-500">{{ $kategori->kategori }}</td>
                                                                <td class="text-bold-500">{{ $kategori->slug }}</td>
                                                                <td class="text-bold-500">
                                                                    <a href="{{ route('edit-kategori-berita', ['id' => $kategori->id]) }}" class="btn icon btn-primary">
                                                                        <i class="bi bi-pencil"></i>
                                                                    </a>
                                                                    <br>
                                                                    <form method="post" action="{{ route('delete-kategori-berita', $kategori->id) }}" class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
