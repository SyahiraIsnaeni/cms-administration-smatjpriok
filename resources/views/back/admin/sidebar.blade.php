            ...
            <ul class="menu">
                ...
                <li
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item  {{ request()->is('dashboard/beranda/prestasi*') ? 'active' : '' }}">
                            <a href="/dashboard/beranda/prestasi" class="submenu-link">Prestasi</a>

                        </li>

                        <li class="submenu-item  {{ request()->is('dashboard/beranda/pengumuman*') ? 'active' : '' }}">
                ...
                <li
                    class="sidebar-item {{ request()->is('dashboard/penjadwalan/kelas*') ? 'active' : '' }}">
                ...
                <li
                    class="sidebar-item {{ request()->is('dashboard/penjadwalan/guru*') ? 'active' : '' }}">
