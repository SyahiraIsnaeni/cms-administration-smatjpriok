                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="{{ route('edit-data-peminjaman', $peminjaman->id)}}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label for="squareText">Nama Peminjam</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Nama" name="nama" value="{{$peminjaman->nama}}">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select name="kelas_id" id="kelas_id" class="form-control">
                                                        ...
                                                        @foreach($kelas as $row)
                                                            <option value="{{ $row->id }}" {{ $row->id == $kelasTerpilih ? 'selected' : '' }}>{{ $row->nama_kelas }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="squareText" class="form-control square" placeholder="Judul Buku" name="judul_buku" value="{{$peminjaman->judul_buku}}">
                                            </div>
                                            <div class="form-group">
