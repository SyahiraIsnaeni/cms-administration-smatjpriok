                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="{{ route('edit-data-kunjungan', $kunjungan->id)}}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label for="squareText">Nama Pengunjung</label>
                                                <input type="text" id="squareText" class="form-control square"  name="nama" value="{{$kunjungan->nama}}">
                                            </div>
                                            <div class="form-group">
