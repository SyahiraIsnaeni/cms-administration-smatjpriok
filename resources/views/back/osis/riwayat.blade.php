                                                        ...
                                                        @forelse($blogs as $blog)
                                                            <tr>
                                                                ...
                                                                <td class="text-bold-500">
                                                                    <form method="post" action="{{ route('restore-riwayat-blog-osis', $blog->id) }}" class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                    ...
                                                                    <br>
                                                                    <form method="post" action="{{ route('delete-riwayat-blog-osis', $blog->id) }}" class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
