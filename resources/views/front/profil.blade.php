...
<nav class="sticky bg-[#0D464B] py-3 lg:py-3.5 top-0 w-full z-30">
    ...
    <div class="md:hidden relative">
        ...
        <div class="hidden md:flex flex-col items-start absolute mt-3 right-0 bg-[#0D464B] p-4 w-48 rounded-l-md rounded-t-none opacity-95 h-screen" id="mobileMenu">
            ...
            <a href="profil.html" class="text-white py-2.5 block text-center text-sm hover:text-[#FF8B42] font-semibold underline underline-offset-8 decoration-2 decoration-[#FF8B42]">Profil</a>
...
<section>
    <div class="w-full bg-[#001A1C] bg-opacity-95">
        <div class="sm:flex pb-5 sm:pb-0">
            <img class="w-full mb-5 sm:mb-0 sm:w-1/2 rounded-br-[400px] xl:h-[600px] lg:h-[500px] md:h-[430px] sm:h-[380px] h-[280px] object-cover object-center" src="{{ asset('images/carousel-profil.jpg') }}" />
...
<section class="my-10 sm:my-12">
    <div class="mx-5 sm:mx-8 md:mx-10 lg:mx-16 xl:mx-20">
        ...
        <div class="text-black block sm:hidden">
            ...
            <img src="{{ asset('images/sma.jpg') }}" alt="Deskripsi Gambar" class="my-3 h-[220px] object-cover object-center rounded-md w-full" />
...
<section class="my-12 sm:my-16 lg:py-5">
    <div class="mx-5 sm:mx-8 md:mx-10 lg:mx-16 xl:mx-20">
        ...
        <div class="text-black block sm:hidden">
            ...
            <img src="{{ asset('images/kepsek.jpg') }}" alt="Kepala sekolah" class="mt-5 mx-auto rounded-md w-[180px] h-[230px] object-cover object-center" />
            <!-- nama kepsek -->
        ...
        <div class="hidden sm:block">
            <div class="flex mt-7 md:mt-10 lg:mt-12 xl:mt-16">
                ...
                <div class="w-4/12 md:w-3/12 xl:2/12 ml-5 lg:ml-12 xl:ml-20">
                    <img src="{{ asset('images/kepsek.jpg') }}" alt="Deskripsi Gambar" class="object-cover w-full h-[250px] lg:h-[275px] xl:h-[330px] md:object-cover md:max-w-full rounded-md shadow-md mt-5 md:mt-2 lg:mt-0" />
...
<section class="relative mt-16 sm:mt-20">
    ...
    <!-- Gambar Latar -->
    <img src="{{ asset('images/school-AI1.jpg') }}" alt="School" class="top-0 left-0 w-full z-0 opacity-80 object-cover object-center h-[840px] sm:h-[790px] md:h-[550px] lg:h-[570px] xl:h-[590px]" />
    ...
    <div class="block md:hidden absolute top-0 left-0 w-full my-8 z-20">
        ...
        <div class="mx-5 sm:mx-8">
            <img src="{{ asset('images/school-AI3.png') }}" alt="Deskripsi Gambar" class="my-6 sm:my-6 w-full max-h-[300px] object-cover object-center rounded-md" />
    ...
    <div class="md:block hidden absolute top-0 left-0 w-full my-8 lg:my-12 z-20">
        <div class="flex z-20 mx-5 sm:mx-8 md:mx-10 lg:mx-16 xl:mx-20">
            ...
            <div class="w-2/5 ml-6 xl:ml-12 relative">
                ...
                <img src="{{ asset('images/school-AI3.png') }}" alt="Deskripsi Gambar" class="object-cover w-full h-[300px] xl:h-[290px] rounded-md mt-10" />
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute inset-x-0 -bottom-5 flex justify-center items-center">
                            <div class="bg-[#FF8B42] rounded-xl w-3/4 py-3 px-3">
                                <h1 class="text-sm font-semibold text-center">{{ $row->nama }}</h1>
                            </div>
                        </div>
                    </div>
                </li>
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute inset-x-0 -bottom-5 flex justify-center items-center">
                                    <div class="bg-[#FF8B42] rounded-xl py-2 px-3 w-3/4  lg:px-3 lg:py-3 xl:px-3 xl:py-3">
                                        <h1 class="text-sm lg:text-[15px] xl:text-[17px] font-semibold text-center">{{ $row->nama }}</h1>
                                    </div>
                                </div>
                            </div>
                        </li>
        ...
        <div class="mt-7">
            ...
            <div class="flex mt-3">
                ...
                <a href="https://www.instagram.com/smatanjungpriok_jkt/">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-5 h-5 sm:h-6 sm:w-6 ml-[9.5px]"
                         fill="#fff"
                         onmouseover="this.querySelector('path').setAttribute('fill', '#FF8B42')"
                         onmouseout="this.querySelector('path').setAttribute('fill', '#ffffff')"><path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"/></svg>
                </a>
                <a href="https://www.facebook.com/SMATjPriok/">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="w-5 h-[17px] sm:h-[23px] sm:w-6 ml-[7.5px]"
                         fill="#fff"
                         onmouseover="this.querySelector('path').setAttribute('fill', '#FF8B42')"
                         onmouseout="this.querySelector('path').setAttribute('fill', '#ffffff')"><path d="M80 299.3V512H196V299.3h86.5l18-97.8H196V166.9c0-51.7 20.3-71.5 72.7-71.5c16.3 0 29.4 .4 37 1.2V7.9C291.4 4 256.4 0 236.2 0C129.3 0 80 50.5 80 159.4v42.1H14v97.8H80z"/></svg>
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="flex">
            <div class="w-1/3">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <h1 class="text-white text-[15px] lg:text-[15.5px] xl:text-base font-semibold">
                            SMA Tanjung Priok Jakarta
                        </h1>
                        <p
            ...
            <div class="w-2/3 ml-10 lg:ml-16 xl:ml-20 grid grid-cols-3 gap-2">
                <div>
                    ...
                    <a href="prestasi.html"
                    ><p class="text-white text-[13px] lg:text-[13.5px] xl:text-sm font-light mt-4 hover:text-[#FF8B42]">
                            Prestasi
                        </p></a
                    >
                    <a href="pengumuman.html"
                    ><p class="text-white text-[13px] lg:text-[13.5px] xl:text-sm font-light mt-2 hover:text-[#FF8B42]">
                            Pengumuman
                        </p></a
                    >
                    <a href="berita.html"
                    ...
                    <a
                        href="konten.html"
                        class="text-white text-[13px] lg:text-[13.5px] xl:text-sm font-light mt-1"
                    ><p class="text-white text-xs sm:text-[13px] font-light mt-2 hover:text-[#FF8B42]">
                            Galeri dan Video
                        </p></a
                    >
                </div>
                ...
                <div>
                    ...
                    <div class="flex mt-4">
                        ...
                        <a href="https://www.instagram.com/smatanjungpriok_jkt/">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="h-6 w-6 ml-[9.5px]"
                                 fill="#fff"
                                 onmouseover="this.querySelector('path').setAttribute('fill', '#FF8B42')"
                                 onmouseout="this.querySelector('path').setAttribute('fill', '#ffffff')"><path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"/></svg>
                        </a>
                        <a href="https://www.facebook.com/SMATjPriok/">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="h-[23px] w-6 ml-[7.5px]"
                                 fill="#fff"
                                 onmouseover="this.querySelector('path').setAttribute('fill', '#FF8B42')"
                                 onmouseout="this.querySelector('path').setAttribute('fill', '#ffffff')"><path d="M80 299.3V512H196V299.3h86.5l18-97.8H196V166.9c0-51.7 20.3-71.5 72.7-71.5c16.3 0 29.4 .4 37 1.2V7.9C291.4 4 256.4 0 236.2 0C129.3 0 80 50.5 80 159.4v42.1H14v97.8H80z"/></svg>
                        </a>
