                                                    ...
                                                    <table class="table table-bordered mb-3" id="table1">
                                                        ...
                                                        <?php $__empty_1 = true; $__currentLoopData = $gurus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php if($guru->foto): ?>
                                                                        <img src="<?php echo e(asset('storage/guru/' . $guru->foto)); ?>" width="100" height="100">
                                                                    <?php else: ?>
                                                                        Tidak ada
                                                                    <?php endif; ?>
                                                                </td>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/admin/data/guru/view.blade.php ENDPATH**/ ?>