                                ...
                                <div class="card-body">
                                    <div class="card-header" style="display: flex">
                                        <div class="card-head-row" style="margin-left: -20px">
                                            <a href="<?php echo e(route("add-kunjungan-perpus")); ?>" class="btn btn-info btn=sm ml-auto"> <i class="bi bi-plus-circle" style="margin-right: 4px"></i>Tambah Data</a>
                                        </div>
                                    </div>
                                                    ...
                                                    <table class="table table-bordered mb-3" id="table1">
                                                        ...
                                                        <?php $__empty_1 = true; $__currentLoopData = $kunjungan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-bold-500"><?php echo e($row->keperluan); ?></td>
                                                                <td class="text-bold-500">
                                                                    <a href="<?php echo e(route('edit-kunjungan-perpus', ['id' => $row->id])); ?>" class="btn icon btn-primary">
                                                                        <i class="bi bi-pencil"></i>
                                                                    </a>
                                                                    <form method="post" action="<?php echo e(route('delete-kunjungan-perpus', $row->id)); ?>" class="d-inline">
                                                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/perpustakaan/kunjungan/view.blade.php ENDPATH**/ ?>