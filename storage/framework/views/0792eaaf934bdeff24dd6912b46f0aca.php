            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Data Mata Pelajaran Masing-Masing Kelas</h3>
                    </div>
                </div>
            </div>
                                                        ...
                                                        <?php $__empty_1 = true; $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-bold-500">
                                                                    <a href="<?php echo e(route('detail-mapel', ['kelasId' => $row->id])); ?>" class="btn icon btn=sm btn-primary">
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/admin/data/mapel/view-kelas.blade.php ENDPATH**/ ?>