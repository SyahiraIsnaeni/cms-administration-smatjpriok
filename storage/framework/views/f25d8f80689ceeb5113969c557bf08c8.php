    ...
    <div class="mx-5 sm:mx-8 md:mx-10 lg:mx-16 xl:mx-20">
        ...
        <div class="hidden sm:block mt-5 md:mt-7 lg:mt-10 xl:mt-12">
            <div class="float-left">
                <img src="<?php echo e(asset('storage/public/ekstrakurikuler-logos/' . $ekskul->logo)); ?>" class="w-[250px] h-[250px] md:w-[270px] md:h-[270px] lg:h-[300px] lg:w-[300px] xl:h-[320px] xl:w-[320px] mr-5 md:mr-10 lg:mr-12 xl:mr-16" >
            </div>
            <div class="">
...
<section class="my-10 sm:my-12 lg:my-16">
    ...
    <div class="mx-5 sm:mx-8 md:mx-10 lg:mx-16 xl:mx-20 mt-5 grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5 sm:gap-5 md:gap-7 lg:gap-10">
        ...
        <img src="<?php echo e(asset('storage/public/ekstrakurikuler-images/' . $image->image)); ?>" class="rounded-md h-[250px] w-full object-cover object-center">
...
<?php /**PATH C:\xampp\htdocs\cms-administration-smatjpriok\resources\views/front/detail-ekstrakurikuler.blade.php ENDPATH**/ ?>