                                                    ...
                                                    <table class="table table-bordered mb-3" id="table1">
                                                        ...
                                                        <?php $__empty_1 = true; $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                ...
                                                                <td><img src=<?php echo e(asset('storage/public/blog/' . $blog->gambar)); ?> width="100" height="100"></td>
                                                                <td>
                                                                ...
                                                                <td class="text-bold-500">
                                                                    <a href="<?php echo e(route('edit-blog', ['id' => $blog->id])); ?>" class="btn icon btn-primary">
                                                                        <i class="bi bi-pencil"></i>
                                                                    </a>
                                                                    <br>
                                                                    <form method="post" action="<?php echo e(route('delete-blog', $blog->id)); ?>" class="d-inline">
                                                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/admin/konten/beranda/blog/view.blade.php ENDPATH**/ ?>