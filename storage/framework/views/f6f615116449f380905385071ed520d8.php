                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="<?php echo e(route("buku-perpus")); ?>" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="<?php echo e(route('edit-data-buku-perpus', $buku->id)); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-group">
                                                <label for="squareText">Judul Buku</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Judul Buku" name="judul" value="<?php echo e($buku->judul); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="squareText">Nama Penerbit</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Penerbit" name="penerbit" value="<?php echo e($buku->penerbit); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="squareText">Jumlah Buku</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Jumlah" name="jumlah" value="<?php echo e($buku->jumlah); ?>">
                                            </div>
                                            <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/perpustakaan/buku/edit.blade.php ENDPATH**/ ?>