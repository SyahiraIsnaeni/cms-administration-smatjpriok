                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="<?php echo e(route("prestasi")); ?>" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="<?php echo e(route('edit-prestasi', $prestasi->id)); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <div class="form-group">
                                                <label for="squareText">Nama Siswa (20 karakter)</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Nama Siswa" name="nama" value="<?php echo e($prestasi->nama); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="squareText">Nama Kejuaraan (40 karakter)</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Nama Kejuaraan" name="kejuaraan" value="<?php echo e($prestasi->kejuaraan); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="squareText">Deskripsi (100 karakter)</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Deskripsi Singkat" name="deskripsi" value="<?php echo e($prestasi->deskripsi); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(asset('storage/prestasi/'.$prestasi->gambar)); ?>" width="100" style="margin-left: 10px">
                                            </div>
                                            <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views\back\admin\konten\beranda\prestasi\edit.blade.php ENDPATH**/ ?>