                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="<?php echo e(route('edit-data-kunjungan', $kunjungan->id)); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-group">
                                                <label for="squareText">Nama Pengunjung</label>
                                                <input type="text" id="squareText" class="form-control square"  name="nama" value="<?php echo e($kunjungan->nama); ?>">
                                            </div>
                                            <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/admin/perpustakaan/kunjungan/edit.blade.php ENDPATH**/ ?>