                ...
                <li class=" mx-5 w-full sm:w-[300px]">
                    <div class="relative">
                        <div class="justify-center items-center border rounded-md border-black border-opacity-25">
                            <img src="<?php echo e(asset('storage/public/fasilitas/' . $row->gambar)); ?>" class="rounded-md w-full h-[180px] object-cover object-center" />
                        </div>
                ...
                <div class="w-full mr-8">
                    <ul class="flex md:gap-8 lg:gap-16 xl:gap-20 2xl:gap-28" id="sliderFasilitasLarge">
                        ...
                        <li class="hidden w-[330px] xl:w-[380px]">
                            <div class="relative">
                                <div class="justify-center items-center border rounded-md border-black border-opacity-25">
                                    <img src="<?php echo e(asset('storage/public/fasilitas/' . $row->gambar)); ?>" class="w-full h-[200px] lg:h-[220px] xl:h-[260px] object-cover object-center border-b border-black border-opacity-25 rounded-md" />
                                </div>
                                <div class="absolute inset-x-0 -bottom-5 flex justify-center items-center">
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/front/profil.blade.php ENDPATH**/ ?>