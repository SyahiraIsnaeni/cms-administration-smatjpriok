...
<section class="relative">
    <!-- Gambar Latar -->
    <img src="<?php echo e(asset('images/guru-staf.jpg')); ?>" alt="School" class="top-0 left-0 z-0 opacity-80 w-full object-cover object-center h-[250px] sm:h-[260px] md:h-[270px] lg:h-[290px] xl:h-[320px]" />
    <!-- overlay warna -->
    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center z-20">
        <p class="text-white font-semibold text-[22px] sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-center tracking-wide mx-5">Guru SMA Tanjung Priok Jakarta</p>
        <p class="text-white font-medium text-[15px] sm:text-base md:text-lg lg:text-xl xl:text-2xl text-center mt-2 sm:mt-2 md:mt-2 lg:mt-4 xl:mt-5 mx-5">Temukan lebih banyak tentang para Pengajar SMA Tanjung Priok Jakarta!</p>
    </div>
</section>
                    ...
                    <div class="relative ">
                        ...
                        <div class="absolute inset-x-0 -bottom-7 flex justify-center items-center">
                            <div class="bg-[#FF8B42] rounded-xl py-2.5 px-3 w-4/5 lg:px-3 lg:py-3 xl:px-3 xl:py-3">
                                <h1 class="text-[15px] sm:text-base md:text-[16.5px] lg:text-[17px] xl:text-[18px] font-bold text-center"><?php echo e($guru->nama); ?></h1>
                                <p class="text-center text-sm lg:text-[15px] xl:text-base font-medium mt-[1px]"><?php echo e($guru->jabatan); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views\front\data-guru.blade.php ENDPATH**/ ?>