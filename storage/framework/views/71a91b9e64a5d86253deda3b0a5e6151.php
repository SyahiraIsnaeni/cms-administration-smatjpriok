                                    ...
                                    <div class="col-sm-12">
                                        <form method="post" action="<?php echo e(route('edit-pengumuman', $pengumuman->id)); ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(asset('storage/pengumuman/gambar/'.$pengumuman->gambar)); ?>" width="100" style="margin-left: 10px">
                                            </div>
                                            <?php if($pengumuman->dokumen != null): ?>
                                                <div class="form-group">
                                                    ...
                                                    <a href="<?php echo e(asset('storage/pengumuman/dokumen/'.$pengumuman->dokumen)); ?>"><?php echo e(asset('storage/pengumuman/dokumen/'.$pengumuman->dokumen)); ?></a>
                                                </div>
                                            <?php else: ?>
                                                <div class="form-group">
                                                    <label for="dokumen">Dokumen Pengumuman (opsional)</label>
