                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                    <form method="post" action="<?php echo e(route('update-peminjaman', ['id' => $peminjamans->id])); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <div class="form-group row">
                                                <label for="squareText" class="col-sm-2 col-form-label">Nama Lengkap</label>
                                                <div class="col-sm-10">
                                                    <input type="text" id="squareText" class="form-control square" placeholder="Nama Siswa" name="nama" value="<?php echo e(old('nama', $peminjamans->nama ?? '')); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
...
unset($__errorArgs, $__bag); ?>">
                                                        ...
                                                        <option value="<?php echo e($kelas->id); ?>" <?php echo e($kelas->id == $peminjamans->kelas_id ? 'selected' : ''); ?>><?php echo e($kelas->nama_kelas); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" id="squareText" class="form-control square" placeholder="Judul Buku" name="judul_buku" value="<?php echo e(old('judul_buku', $peminjamans->judul_buku ?? '')); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('tanggal_pinjam', isset($peminjamans) ? $peminjamans->tanggal_pinjam : '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="date" name="tanggal_kembali" class="form-control <?php $__errorArgs = ['tanggal_kembali'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('tanggal_kembali', isset($peminjamans) ? $peminjamans->tanggal_kembali : '')); ?>">
...
<?php /**PATH C:\xampp\htdocs\cms-administration-smatjpriok-2\resources\views/back/admin/data/peminjaman/edit.blade.php ENDPATH**/ ?>