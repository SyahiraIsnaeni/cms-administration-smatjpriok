...
<head>
    ...
    <title>Dashboard OSIS - SMA Tanjung Priok</title>
...
<div id="app">
    ...
    <div id="main">
        ...
        <div class="page-heading">
            <h3>Dashboard OSIS SMA Tanjung Priok Jakarta</h3>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    <h6 class="text-muted font-semibold"><p><b>Galeri</b></p></h6>
                                    <h6 class="font-extrabold mb-0"><?php echo e($galeri->COUNT('id')); ?></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <?php $__empty_1 = true; $__currentLoopData = $drafBlog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <div class="row fs-5" style="margin-bottom: -20px">
                                                                ...
                                                                <div class="col-1 col-md-1 col-lg-1 mt-3 mb-3">
                                                                    <a href="<?php echo e(route('edit-blog-osis', $row->id)); ?>"
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views\back\osis\dashboard.blade.php ENDPATH**/ ?>