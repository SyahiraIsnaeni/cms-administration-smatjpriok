...
<section class="relative">
    <!-- Gambar Latar -->
    <img src="<?php echo e(asset('images/prestasi3.png')); ?>" alt="School" class="top-0 left-0 z-0 opacity-80 w-full object-cover object-center h-[290px] sm:h-[300px] md:h-[310px] lg:h-[330px] xl:h-[350px]" />
    <!-- overlay warna -->
...
<section class="my-12 md:my-16">
    ...
    <div class="block sm:hidden mx-5 mt-3">
        ...
        <div class="relative mt-5">
            <img src="<?php echo e(asset('storage/public/prestasi/' . $prestasi->gambar)); ?>" class="w-full h-[250px] object-cover object-center" />
            <div class="bg-[#0D464B] bg-gradient-to-t from-[#0D464B] via-[#13494D]/75 to-[#737373]/20 bg-opacity-25 absolute top-0 h-full w-full items-center flex">
                <h1 class="text-base font-medium w-full text-white text-end mt-auto mx-auto px-5 pb-5 leading-relaxed">
                    <?php echo e($prestasi->nama); ?>

                    <p class="text-base font-light text-end mt-auto mx-auto pb-2 leading-relaxed"><?php echo e($prestasi->kejuaraan); ?></p>
                </h1>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <nav aria-label="Page navigation example ">
                <ul class="flex items-center mt-5 justify-center -space-x-px h-8 text-sm">
                    <li>
                        <a href="<?php echo e($prestasis->previousPageUrl()); ?>" >
                    ...
                    <li>
                        <a href="<?php echo e($prestasis->nextPageUrl()); ?>" >
    ...
    <div class="hidden sm:mx-8 sm:block md:mx-10 lg:mx-16 xl:mx-20 mt-7 md:mt-8 lg:mt-10 xl:mt-12">
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-5 md:gap-7 lg:gap-8">
            <?php $__currentLoopData = $prestasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prestasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="relative">
                <img src="<?php echo e(asset('storage/public/prestasi/' . $prestasi->gambar)); ?>" class="w-full h-[270px] xl:h-[300px] object-cover rounded-md object-center" />
                <div class="bg-[#0D464B] bg-gradient-to-t from-[#0D464B] via-[#13494D]/20 to-[#737373]/10 bg-opacity-25 absolute top-0 h-full w-full items-center flex">
                    <h1 class="text-base font-medium text-white w-full text-end mr-5 mt-auto pb-2 leading-relaxed z-10">
                        ...
                        <p class="text-base font-light text-white w-full text-end mr-10 pb-4 mt-auto leading-relaxed"><?php echo e($prestasi->kejuaraan); ?></p>
                    </h1>
                </div>
                <div class="opacity-0 hover:opacity-100 z-0">
                    <div class="bg-[#0D464B] bg-opacity-80 absolute top-0 h-full w-full items-center flex">
                        <p class="text-lg lg:text-[19px] xl:text-[21px] font-light text-white w-full h-full text-start mt-32 px-5 leading-relaxed"><?php echo e($prestasi->deskripsi); ?></p>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/front/prestasi.blade.php ENDPATH**/ ?>