                                        ...
                                        <form method="post" action="<?php echo e(route('edit-ekstrakurikuler', $ekstrakurikuler->id)); ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php $__currentLoopData = $ekstrakurikuler->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <img src="<?php echo e(asset('storage/public/ekstrakurikuler-images/'.$image->image)); ?>" width="100" style="margin-left: 10px">
...
<?php /**PATH C:\xampp\htdocs\cms-administration-smatjpriok\resources\views/back/admin/konten/beranda/ekstrakurikuler/edit.blade.php ENDPATH**/ ?>