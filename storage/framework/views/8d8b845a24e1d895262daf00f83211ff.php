...
<body class="bg-[#0D464B] dark:bg-dark dark:text-light">
        ...
        <div class="flex flex-col items-start space-y-3 sm:flex-row sm:space-y-0 sm:items-center sm:space-x-3">
            ...
            <div class="space-y-2">
                ...
                <p class="text-base font-normal text-gray-300">
                    You may return to
                    <a href="<?php echo e(route("home")); ?>" class="hover:underline text-[#FF8B42]">home page</a>.
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/front/not-found.blade.php ENDPATH**/ ?>