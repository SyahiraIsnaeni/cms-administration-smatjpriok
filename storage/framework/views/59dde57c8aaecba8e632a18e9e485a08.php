...
<div id="app">
    <?php echo $__env->make('back.osis.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Edit Data Galeri Kegiatan</h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="<?php echo e(route("galeri-osis")); ?>" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="<?php echo e(route('edit-galeri-osis', $galeri->id)); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <div class="form-group">
                                                <label for="squareText">Judul Galeri Kegiatan (maksimal 40 karakter)</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Judul Kegiatan" name="judul" value="<?php echo e($galeri->judul); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(asset('storage/galeri-thumbnail/'.$galeri->thumbnail)); ?>" width="100" style="margin-left: 10px">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <?php $__currentLoopData = $galeri->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <img src="<?php echo e(asset('storage/galeri-images/'.$image->image)); ?>" width="100" style="margin-left: 10px">
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views\back\osis\galeri\edit.blade.php ENDPATH**/ ?>