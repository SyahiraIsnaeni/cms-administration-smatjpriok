                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form action="<?php echo e(route('import-staf')); ?>" method="post" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                ...
                                <div style="margin-top: 15px">
                                    <a href="<?php echo e(asset('storage/template-staf.xlsx')); ?>" style="text-decoration: underline">Download Template Excel Data Staf</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/admin/data/staf/import.blade.php ENDPATH**/ ?>