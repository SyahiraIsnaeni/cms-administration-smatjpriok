        ...
        <div class="w-full">
            <div class="grid min-[500px]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-16 min-[500px]:gap-y-12 sm:gap-y-16 md:gap-y-12 lg:gap-y-16 min-[500px]:gap-7 sm:gap-16 md:gap-16 lg:gap-5 xl:gap-16">
                ...
                <div class="w-full">
                    <div class="relative ">
                        <div class="w-full">
                            <img src="<?php echo e(asset('storage/staf/' . $staf->foto)); ?>" class="object-cover w-full h-[370px] min-[400px]:h-[500px] min-[500px]:h-[320px] sm:h-[330px] md:h-[300px] lg:h-[300px] xl:h-[350px] object-top rounded-md" />
                        </div>
