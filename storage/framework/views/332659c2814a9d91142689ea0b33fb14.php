...
<section class="my-12 md:my-16">
    ...
    <div class="block sm:hidden mx-5 mt-3">
        ...
        <div class="relative mt-5">
            <img src="<?php echo e(asset('storage/prestasi/' . $prestasi->gambar)); ?>" class="w-full h-[250px] object-cover object-center" />
    ...
    <div class="hidden sm:mx-8 sm:block md:mx-10 lg:mx-16 xl:mx-20 mt-7 md:mt-8 lg:mt-10 xl:mt-12">
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-5 md:gap-7 lg:gap-8">
            <?php $__currentLoopData = $prestasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prestasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="relative">
                <img src="<?php echo e(asset('storage/prestasi/' . $prestasi->gambar)); ?>" class="w-full h-[270px] xl:h-[300px] object-cover rounded-md object-center" />
