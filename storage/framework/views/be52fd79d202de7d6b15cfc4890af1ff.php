                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                    <form action="<?php echo e(route('store-peminjaman')); ?>" method="POST" class='mt-3' >
                                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\cms-administration-smatjpriok-2\resources\views/back/admin/data/peminjaman/add.blade.php ENDPATH**/ ?>