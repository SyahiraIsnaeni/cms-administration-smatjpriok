                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="<?php echo e(route('detail-siswa', ['kelasId' => $kelas->id])); ?>" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form action="<?php echo e(route('add-siswa-import', ['kelasId' => $kelas->id])); ?>" method="post" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                ...
                                <div style="margin-top: 15px">
                                    <a href="<?php echo e(asset('storage/template-siswa.xlsx')); ?>" style="text-decoration: underline">Download Template Excel Data Siswa</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views\back\admin\data\siswa\import.blade.php ENDPATH**/ ?>