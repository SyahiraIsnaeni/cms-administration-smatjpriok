                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="<?php echo e(route("blog-osis")); ?>" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="<?php echo e(route('edit-blog-osis', $blog->id)); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <div class="form-group">
                                                <label for="squareText">Judul Blog</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Judul Blog" name="judul" value="<?php echo e($blog->judul); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="squareText">Penulis</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Nama Penulis" name="penulis" value="<?php echo e($blog->penulis); ?>">
                                            </div>
                                            <div class="form-group" style="margin-top: 20px">
                                                <label for="squareText">Isi Blog</label>
                                                <textarea id="inp_editor1" name="konten">
                                                 &lt;p&gt;<?php echo e($blog->konten); ?>&lt;/p&gt;
                                                </textarea>
                                                <script>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(asset('storage/blog/'.$blog->gambar)); ?>" width="100" style="margin-left: 10px">
                                            </div>
                                            <div class="form-group">
                                                <label for="status">Status</label>
                                                <select name="is_active" class="form-control">
                                                    <option value="1" <?php echo e($blog->is_active == '1' ? 'selected' : ''); ?>>
                                                        Terbitkan
                                                    </option>
                                                    <option value="0" <?php echo e($blog->is_active == '0' ? 'selected' : ''); ?>>
                                                        Draf
                                                    </option>
                                                </select>
                                            </div>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views\back\osis\blog\edit.blade.php ENDPATH**/ ?>