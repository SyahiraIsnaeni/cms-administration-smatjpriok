                                                        ...
                                                        <?php $__empty_1 = true; $__currentLoopData = $buku; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-bold-500">
                                                                    <?php if($row->jumlah != 0): ?>
                                                                        <a href="<?php echo e(route('detail-peminjaman-perpus', ['id' => $row->id])); ?>" class="btn icon btn-primary">
                                                                            Tambah Peminjaman
                                                                        </a>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/perpustakaan/peminjaman/search.blade.php ENDPATH**/ ?>