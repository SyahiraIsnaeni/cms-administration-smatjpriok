            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Data Kategori Pengumuman</h3>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                    <div class="card-header">
                                        <div class="card-head-row" style="margin-left: -20px">
                                            <a href="/dashboard/kategori/kategori-pengumuman/add" class="btn btn-info btn=sm ml-auto"> <i class="bi bi-plus-circle" style="margin-right: 4px"></i>Tambah Data</a>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body" >
                                                <div class="table-responsive" style="margin-left: -20px;margin-top: -20px;">
                                                    <table class="table table-bordered mb-3" id="table1">
                                                        ...
                                                        <tbody>
                                                        <?php $__empty_1 = true; $__currentLoopData = $kategori_pengumumans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                <td class="text-bold-500"><?php echo e($kategori->kategori); ?></td>
                                                                <td class="text-bold-500"><?php echo e($kategori->slug); ?></td>
                                                                <td class="text-bold-500">
                                                                    <a href="<?php echo e(route('edit-kategori-pengumuman', ['id' => $kategori->id])); ?>" class="btn icon btn-primary">
                                                                        <i class="bi bi-pencil"></i>
                                                                    </a>
                                                                    <br>
                                                                    <form method="post" action="<?php echo e(route('delete-kategori-pengumuman', $kategori->id)); ?>" class="d-inline">
                                                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views\back\admin\konten\kategori\kategori-pengumuman\view.blade.php ENDPATH**/ ?>