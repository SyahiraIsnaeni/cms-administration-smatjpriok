                                                        ...
                                                        <?php $__empty_1 = true; $__currentLoopData = $beritas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $berita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-bold-500">
                                                                    <form method="post" action="<?php echo e(route('restore-riwayat-berita', $berita->id)); ?>" class="d-inline">
                                                                        <?php echo csrf_field(); ?>
                                                                    ...
                                                                    <br>
                                                                    <form method="post" action="<?php echo e(route('delete-riwayat-berita', $berita->id)); ?>" class="d-inline">
                                                                        <?php echo csrf_field(); ?>
                                                                        <?php echo method_field('DELETE'); ?>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/admin/konten/riwayat/berita.blade.php ENDPATH**/ ?>