                                ...
                                <div class="card-body">
                                    <div class="card-header">
                                        <div class="card-head-row" style="margin-left: -20px">
                                            <a href="/dashboard/profil/fasilitas/add" class="btn btn-info btn=sm ml-auto"> <i class="bi bi-plus-circle" style="margin-right: 4px"></i>Tambah Data</a>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body" >
                                                <div class="table-responsive" style="margin-left: -20px;margin-top: -20px;">
                                                    <table class="table table-bordered mb-3" id="table1">
                                                        ...
                                                        <tbody>
                                                        <?php $__empty_1 = true; $__currentLoopData = $fasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                <td class="text-bold-500"><?php echo e($data->nama); ?></td>
                                                                <td><img src=<?php echo e(asset('storage/public/fasilitas/' . $data->gambar)); ?> width="100" height="100"></td>
                                                                <td><?php echo e($data->updated_at->format('d M Y')); ?></td>
                                                                <td class="text-bold-500">
                                                                    <a href="<?php echo e(route('edit-fasilitas', ['id' => $data->id])); ?>" class="btn icon btn-primary">
                                                                        <i class="bi bi-pencil"></i>
                                                                    </a>
                                                                    <br>
                                                                    <form method="post" action="<?php echo e(route('delete-fasilitas', $data->id)); ?>" class="d-inline">
                                                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/admin/konten/profil/fasilitas/view.blade.php ENDPATH**/ ?>