                                    ...
                                    <div class="col-sm-12">
                                        <form method="post" action="<?php echo e(route('edit-guru', $guru->id)); ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php if($guru->foto): ?>
                                                    <img src="<?php echo e(asset('storage/public/guru/'.$guru->foto)); ?>" width="100" style="margin-left: 10px">
                                                <?php else: ?>
                                                    <p>Belum ada foto</p>
                                                <?php endif; ?>
                                            </div>
...
<?php /**PATH C:\xampp\htdocs\cms-administration-smatjpriok-2\resources\views/back/admin/data/guru/edit.blade.php ENDPATH**/ ?>