            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Data Penjadwalan Siswa Masing-Masing Kelas</h3>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="table-responsive" style="margin-left: -20px;margin-top: -20px;">
                                                    <table class="table table-bordered mb-3" id="table1">
                                                        ...
                                                        <?php $__empty_1 = true; $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                <td class="text-bold-500"><?php echo e($row->nama_kelas); ?></td>
                                                                <td class="text-bold-500">
                                                                    <a href="<?php echo e(route('get-jadwal-kelas', ['kelasId' => $row->id])); ?>" class="btn icon btn=sm btn-primary">
                                                                        Lihat Jadwal
                                                                    </a>
                                                                    <br>
                                                                </td>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/admin/penjadwalan/view-kelas.blade.php ENDPATH**/ ?>