                                ...
                                <div class="card-body">
                                    <div class="card-header">
                                        <div class="card-head-row" style="margin-left: -20px">
                                            <a href="/dashboard/beranda/berita/add" class="btn btn-info btn=sm ml-auto"> <i class="bi bi-plus-circle" style="margin-right: 4px"></i>Tambah Data</a>
                                        </div>
                                    </div>
                                                ...
                                                <div class="table-responsive" style="margin-left: -20px;margin-top: -20px;">
                                                    <table class="table table-bordered mb-3" id="table1">
                                                        ...
                                                        <?php $__empty_1 = true; $__currentLoopData = $beritas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $berita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                <td class="text-bold-500"><?php echo e($berita->judul); ?></td>
                                                                <td class="text-bold-500"><?php echo e($berita->penulis); ?></td>
                                                                <td><img src=<?php echo e(asset('storage/public/berita/' . $berita->gambar)); ?> width="100" height="100"></td>
                                                                <td class="text-bold-500"><?php echo e($berita->kategoriBerita->kategori); ?></td>
                                                                <td>
                                                                    <?php if($berita->is_active == '1'): ?>
                                                                        Diterbitkan
                                                                    <?php else: ?>
                                                                        Draf
                                                                    <?php endif; ?>
                                                                </td>
                                                                <td><?php echo e($berita->updated_at->format('d M Y')); ?></td>
                                                                <td class="text-bold-500">
                                                                    <a href="<?php echo e(route('edit-berita', ['id' => $berita->id])); ?>" class="btn icon btn-primary">
                                                                        <i class="bi bi-pencil"></i>
                                                                    </a>
                                                                    <br>
                                                                    <form method="post" action="<?php echo e(route('delete-berita', $berita->id)); ?>" class="d-inline">
                                                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/admin/konten/beranda/berita/view.blade.php ENDPATH**/ ?>