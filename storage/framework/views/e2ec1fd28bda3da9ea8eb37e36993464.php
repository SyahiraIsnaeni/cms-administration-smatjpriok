                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="<?php echo e(route("fasilitas")); ?>" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="<?php echo e(route('edit-fasilitas', $fasilitas->id)); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <div class="form-group">
                                                <label for="squareText">Nama Fasilitas (20 karakter)</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Nama Fasilitas" name="nama" value="<?php echo e($fasilitas->nama); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(asset('storage/fasilitas/'.$fasilitas->gambar)); ?>" width="100" style="margin-left: 10px">
                                            </div>
                                            <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views\back\admin\konten\profil\fasilitas\edit.blade.php ENDPATH**/ ?>