    ...
    <div class="lg:pt-5 mx-5 sm:mx-8 md:mx-10 lg:mx-16 xl:mx-20 lg:flex">
        <div class="lg:w-2/3 xl:w-3/4">
            ...
            <div class="mt-7 md:mt-10 grid sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-5 md:gap-8 xl:gap-5">
                ...
                <div>
                    <img src="<?php echo e(asset('storage/galeri-images/'.$image->image)); ?>" class="object-cover object-center w-full h-[250px]">
                </div>
        ...
        <div class="mt-10 lg:mt-0 lg:w-1/3 xl:w-1/4 lg:ml-12 xl:ml-16">
            ...
            <div class="mt-5">
                ...
                <div class="mt-3 lg:mt-6 sm:grid sm:grid-cols-2 lg:grid-cols-none sm:gap-5 md:gap-8 lg:gap-5">
                    <?php $__currentLoopData = $nextGaleri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('detail-galeri', ['id' => $row->id])); ?>">
                        <div class="relative h-[240px] mt-5 sm:mt-0  hover:scale-105 ease-in-out duration-300">
                            <img src="<?php echo e(asset('storage/galeri-thumbnail/' . $row->thumbnail)); ?>" class="w-full object-cover object-center h-full">
                            <div class="bg-[#0D464B]  text-white bg-gradient-to-t from-[#0D464B] via-[#13494D]/50 to-[#737373]/5 bg-opacity-25 absolute top-0 h-full w-full">
                                <div class="bottom-0 absolute mx-5 my-5">
                                    <h1 class="mt-auto text-base sm:text-[17px] font-medium leading-relaxed"><?php echo e($row->judul); ?></h1>
                                </div>
                            </div>
                        </div>
                    </a>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views\front\detail-galeri.blade.php ENDPATH**/ ?>