                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="<?php echo e(route("pengumuman")); ?>" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="<?php echo e(route('edit-pengumuman', $pengumuman->id)); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <div class="form-group">
                                                <label for="squareText">Judul Pengumuman</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Judul Pengumuman" name="judul" value="<?php echo e($pengumuman->judul); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="squareText">Penulis</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Nama Penulis" name="penulis" value="<?php echo e($pengumuman->penulis); ?>">
                                            </div>
                                            <div class="form-group" style="margin-top: 20px">
                                                <label for="squareText">Isi Pengumuman</label>
                                                <textarea id="inp_editor1" name="konten">
                                                 &lt;p&gt;<?php echo e($pengumuman->konten); ?>&lt;/p&gt;
                                                </textarea>
                                                <script>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="kategori_pengumuman_id" class="form-control">
                                                    <?php $__currentLoopData = $kategori_pengumumans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($kategori->id == $kategori->kategori_pengumuman_id): ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(asset('storage/public/pengumuman/gambar/'.$pengumuman->gambar)); ?>" width="100" style="margin-left: 10px">
                                            </div>
                                            <?php if($pengumuman->dokumen != null): ?>
                                                <div class="form-group">
                                                    ...
                                                    <a href="<?php echo e(asset('storage/public/pengumuman/dokumen/'.$pengumuman->dokumen)); ?>"><?php echo e(asset('storage/pengumuman/dokumen/'.$pengumuman->dokumen)); ?></a>
                                                </div>
                                            <?php else: ?>
                                                <div class="form-group">
                                                    <label for="dokumen">Dokumen Pengumuman (opsional)</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="is_active" class="form-control">
                                                    <option value="1" <?php echo e($pengumuman->is_active == '1' ? 'selected' : ''); ?>>
                                                        Terbitkan
                                                    </option>
                                                    <option value="0" <?php echo e($pengumuman->is_active == '0' ? 'selected' : ''); ?>>
                                                        Draf
                                                    </option>
                                                </select>
                                            </div>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/back/admin/konten/beranda/pengumuman/edit.blade.php ENDPATH**/ ?>