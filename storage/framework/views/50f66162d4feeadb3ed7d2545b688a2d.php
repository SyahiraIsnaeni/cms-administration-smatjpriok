                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="<?php echo e(route("staf")); ?>" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="<?php echo e(route('edit-staf', $staf->id)); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <div class="form-group">
                                                <label for="squareText">Nama Lengkap</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Nama Staf" name="nama" value="<?php echo e($staf->nama); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="squareText">NIP</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="NIP Staf" name="nip" value="<?php echo e($staf->nip); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="squareText">Jabatan</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Jabatan Staf" name="jabatan" value="<?php echo e($staf->jabatan); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <?php if($staf->foto): ?>
                                                    <img src="<?php echo e(asset('storage/staf/'.$staf->foto)); ?>" width="100" style="margin-left: 10px">
                                                <?php else: ?>
                                                    <p>Belum ada foto</p>
                                                <?php endif; ?>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="email" id="squareText" class="form-control square" placeholder="Email Guru" name="email" value="<?php echo e($staf->email); ?>">
                                            </div>
                                            <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views\back\admin\data\staf\edit.blade.php ENDPATH**/ ?>