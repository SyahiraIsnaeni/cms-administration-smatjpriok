    ...
    <div class="mx-5 sm:mx-8 md:mx-10 lg:mx-16 xl:mx-20">
        <div class="w-full">
            <div class="grid min-[500px]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-16 min-[500px]:gap-y-12 sm:gap-y-16 md:gap-y-12 lg:gap-y-16 min-[500px]:gap-7 sm:gap-16 md:gap-16 lg:gap-5 xl:gap-16">
                <?php $__currentLoopData = $stafs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="w-full">
                    <div class="relative ">
                        <div class="w-full">
                            <img src="<?php echo e(asset('storage/public/staf/' . $staf->foto)); ?>" class="object-cover w-full h-[370px] min-[400px]:h-[500px] min-[500px]:h-[320px] sm:h-[330px] md:h-[300px] lg:h-[300px] xl:h-[350px] object-top rounded-md" />
                        </div>
                        <div class="absolute inset-x-0 -bottom-7 flex justify-center items-center">
                            <div class="bg-[#FF8B42] rounded-xl py-2.5 px-3 w-4/5 lg:px-3 lg:py-3 xl:px-3 xl:py-3">
                                <h1 class="text-[15px] sm:text-base md:text-[16.5px] lg:text-[17px] xl:text-[18px] font-bold text-center"><?php echo e($staf->nama); ?></h1>
                                <p class="text-center text-sm lg:text-[15px] xl:text-base font-medium mt-[1px]"><?php echo e($staf->jabatan); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views/front/data-staf.blade.php ENDPATH**/ ?>