                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="<?php echo e(route("ekstrakurikuler")); ?>" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="<?php echo e(route('edit-ekstrakurikuler', $ekstrakurikuler->id)); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <div class="form-group">
                                                <label for="squareText">Nama Ekstrakurikuler</label>
                                                <input type="text" id="squareText" class="form-control square" placeholder="Ekstrakurikuler" name="nama" value="<?php echo e($ekstrakurikuler->nama); ?>">
                                            </div>
                                            <div class="form-group" style="margin-top: 20px">
                                                <label for="squareText">Deskripsi Ekstrakurikuler</label>
                                                <textarea name="deskripsi" class="form-control" id="task-textarea" style="height: 200px"><?php echo e($ekstrakurikuler->deskripsi); ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(asset('storage/ekstrakurikuler-logos/'.$ekstrakurikuler->logo)); ?>" width="100" style="margin-left: 10px">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <?php $__currentLoopData = $ekstrakurikuler->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <img src="<?php echo e(asset('storage/ekstrakurikuler-images/'.$image->image)); ?>" width="100" style="margin-left: 10px">
...
<?php /**PATH C:\xampp\htdocs\Capstone\sistem-manajemen-konten-dan-administrasi\cms_administration_smatjpriok\resources\views\back\admin\konten\beranda\ekstrakurikuler\edit.blade.php ENDPATH**/ ?>